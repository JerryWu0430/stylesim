      ...
      {items.map((item, idx) => (
        ...
        >
          {hovered === idx && (
            <motion.div
              layoutId="hovered"
              className="absolute inset-0 h-full w-full rounded-full bg-foreground/5"
            />
          )}
...
export const NavbarLogo = ({
  ...
  return (
    ...
    >
      {src && (
        <img src={src} alt={alt || "logo"} className="h-8 w-auto" />
      )}
      {children}
    </a>
  );
...
export const NavbarButton = ({
  ...
  const variantStyles = {
    primary:
      "bg-white text-foreground shadow-[0_0_24px_rgba(34,_42,_53,_0.06),_0_1px_1px_rgba(0,_0,_0,_0.05),_0_0_0_1px_rgba(34,_42,_53,_0.04),_0_0_4px_rgba(34,_42,_53,_0.08),_0_16px_68px_rgba(47,_48,_55,_0.05),_0_1px_0_rgba(255,_255,_255,_0.1)_inset]",
    ...
    gradient:
      "bg-gradient-to-b from-accent to-accent/80 text-white shadow-[0px_2px_0px_0px_rgba(255,255,255,0.3)_inset]",
  };
